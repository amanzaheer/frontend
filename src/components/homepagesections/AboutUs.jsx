    ...
    <FullContainer className="text-center mt-12">
      <Container>
        ...
        <p className="font-medium text-gray-600">
          Welcome to Bagh-e-Stan - your one-stop destination for all your
          gardening needs! 🌿🌻 At Bagh-e-Stan, we have reimagined the way
          ...
          more! Bagh-e-Stan Marketplace is not just about finding expert
          gardeners; {"it's"} also a thriving marketplace where Bagh-e-Stan
          ...
          eager gardeners. At Bagh-e-Stan, we
